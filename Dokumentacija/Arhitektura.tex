...
\begin{itemize}
\item Korisnik(i njegovi podtipovi klijent, nutricionist i kulinarski entuzijast)
\item Recept
\item Korak
...
\textbf{Korisnik}- opisuje sve korisnike koji se registrirani na stranici. Pošto postoji više vrsta korisnika,
tako ima i više tablica koje drže informacije svih korisnika. Entitet korisnik je glavni entitet, a entiteti klijent,
nutricionist i kulinarski entuzijast su njegove specijalizacije. Entitet korisnik ima osnovne informacije  o korisnicima
t.j. ima atribute Korisničko ime(Posebno za svakog korisnika), lozinku, ime i prezime. Tablice nutricionist i Kulinarski entuzijast
sadrže dodatne informacije koje su potrebne za takve korisnike(Slika, email,biografija). Tablica klijent sadrži korisnička imena svih 
korisnika koji nisu nutricionisti ili kulinarski entuzijasti. Korisnik je povezan sa dijetom koju prati preko imena dijete(N,1 veza).
...
\begin{longtblr}[
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Klijent}}	 \\ \hline[3pt]
					\SetCell{LightGreen}KorisnickoIme & VARCHAR & Korisničko ime korisnika \\ \hline
					Lozinka & VARCHAR & Lozinka korisnika \\ \hline 
					Ime & VARCHAR & Ime korisnika \\ \hline
					Prezime & VARCHAR & Prezime korisnika \\ \hline 
					\SetCell{LightBlue} KorisnickoIme & VARCHAR & Korisnicko ime klijenta \\ \hline 
				\end{longtblr}
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Kulinarski entuzijast}}	 \\ \hline[3pt]
					\SetCell{LightGreen}KorisnickoIme & VARCHAR & Korisničko ime korisnika \\ \hline
				...
				\begin{longtblr}[
					...
					\hline \SetCell[c=3]{c}{\textbf{Nutricionist}}	 \\ \hline[3pt]
					\SetCell{LightGreen}KorisnickoIme & VARCHAR & Korisničko ime korisnika \\ \hline
					Biografija & VARCHAR & Biografija korisnika \\ \hline
					Email & VARCHAR & E-mail adresa korisnika \\ \hline
					\SetCell{LightBlue} IDslika & INT & ID slike korisnika \\ \hline 
